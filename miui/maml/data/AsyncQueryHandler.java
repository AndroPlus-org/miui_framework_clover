...
_L7:
    ...
    public AsyncQueryHandler(ContentResolver contentresolver)
    {
        ...
        if(sLooper == null)
        {
            contentresolver = JVM INSTR new #53  <Class HandlerThread>;
    ...
    public AsyncQueryHandler(Looper looper, ContentResolver contentresolver)
    {
        ...
        if(sLooper == null)
        {
            looper = JVM INSTR new #53  <Class HandlerThread>;
            looper.HandlerThread("AsyncQueryWorker");
            looper.start();
            sLooper = looper.getLooper();
        }
        android/content/AsyncQueryHandler;
        JVM INSTR monitorexit ;
        mWorkerThreadHandler = createHandler(sLooper);
