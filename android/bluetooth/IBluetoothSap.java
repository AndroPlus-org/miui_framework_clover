    ...
    extends IInterface
{
        ...
        implements IBluetoothSap
    {
        ...
        public static IBluetoothSap asInterface(IBinder ibinder)
        {
            if(ibinder == null)
                return null;
            IInterface iinterface = ibinder.queryLocalInterface("android.bluetooth.IBluetoothSap");
            ...
            throws RemoteException
        {
            ...
            case 1598968902: 
                parcel1.writeString("android.bluetooth.IBluetoothSap");
                return true;

            case 1: // '\001'
                parcel.enforceInterface("android.bluetooth.IBluetoothSap");
                i = getState();
        ...
        implements IBluetoothSap
    {
            ...
            throws RemoteException
        {
            ...
            parcel.writeInterfaceToken("android.bluetooth.IBluetoothSap");
