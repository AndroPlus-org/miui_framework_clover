...
public class LomoishFilter extends Filter
{
    ...
    private void initParameters()
    {
        if(mProgram != null)
        {
            ...
            mProgram.setHostValue("stepsizeX", Float.valueOf(1.0F / (float)mWidth));
            mProgram.setHostValue("stepsizeY", Float.valueOf(1.0F / (float)mHeight));
            f = mRandom.nextFloat();
