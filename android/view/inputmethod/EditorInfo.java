    ...
    implements InputType, Parcelable
{
    ...
    public void dump(Printer printer, String s)
    {
        ...
        printer.println((new StringBuilder()).append(s).append("hintLocales=").append(hintLocales).toString());
        printer.println((new StringBuilder()).append(s).append("contentMimeTypes=").append(Arrays.toString(contentMimeTypes)).toString());
    }
...
_L2:
        return;
_L4:
        inputType = inputType & 0xfff000 | 0x21;
        continue; /* Loop/switch isn't completed */
_L5:
        inputType = inputType & 0xfff000 | 0x81;
        continue; /* Loop/switch isn't completed */
_L3:
        inputType = inputType & 0xfff000 | 2;
...
_L6:
    ...
    public void writeToParcel(Parcel parcel, int i)
    {
        ...
        if(hintLocales != null)
            hintLocales.writeToParcel(parcel, i);
        else
            LocaleList.getEmptyLocaleList().writeToParcel(parcel, i);
        parcel.writeStringArray(contentMimeTypes);
    }
    ...
    public static final android.os.Parcelable.Creator CREATOR = new android.os.Parcelable.Creator() {
        ...
        public EditorInfo createFromParcel(Parcel parcel)
        {
            ...
            LocaleList localelist = (LocaleList)LocaleList.CREATOR.createFromParcel(parcel);
            LocaleList localelist1 = localelist;
            if(localelist.isEmpty())
                localelist1 = null;
            editorinfo.hintLocales = localelist1;
