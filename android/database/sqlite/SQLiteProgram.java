...
_L1:
        ...
        if(i == 1)
            ...
            flag = false;
        s = new SQLiteStatementInfo();
        sqlitedatabase.getThreadSession().prepare(mSql, sqlitedatabase.getThreadDefaultConnectionFlags(flag), cancellationsignal, s);
        mReadOnly = ((SQLiteStatementInfo) (s)).readOnly;
        mColumnNames = ((SQLiteStatementInfo) (s)).columnNames;
        mNumParameters = ((SQLiteStatementInfo) (s)).numParameters;
_L4:
