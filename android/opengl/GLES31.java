...
public class GLES31 extends GLES30
{
    ...
    public static native void glActiveShaderProgram(int i, int j);

    public static native void glBindImageTexture(int i, int j, int k, boolean flag, int l, int i1, int j1);

    public static native void glBindProgramPipeline(int i);

    public static native void glBindVertexBuffer(int i, int j, long l, int k);

    public static native int glCreateShaderProgramv(int i, String as[]);

    public static native void glDeleteProgramPipelines(int i, IntBuffer intbuffer);

    public static native void glDeleteProgramPipelines(int i, int ai[], int j);

    public static native void glDispatchCompute(int i, int j, int k);

    public static native void glDispatchComputeIndirect(long l);

    public static native void glDrawArraysIndirect(int i, long l);

    public static native void glDrawElementsIndirect(int i, int j, long l);

    public static native void glFramebufferParameteri(int i, int j, int k);

    public static native void glGenProgramPipelines(int i, IntBuffer intbuffer);

    public static native void glGenProgramPipelines(int i, int ai[], int j);

    public static native void glGetBooleani_v(int i, int j, IntBuffer intbuffer);

    public static native void glGetBooleani_v(int i, int j, boolean aflag[], int k);

    public static native void glGetFramebufferParameteriv(int i, int j, IntBuffer intbuffer);

    public static native void glGetFramebufferParameteriv(int i, int j, int ai[], int k);

    public static native void glGetMultisamplefv(int i, int j, FloatBuffer floatbuffer);

    public static native void glGetMultisamplefv(int i, int j, float af[], int k);

    public static native void glGetProgramInterfaceiv(int i, int j, int k, IntBuffer intbuffer);

    public static native void glGetProgramInterfaceiv(int i, int j, int k, int ai[], int l);

    public static native String glGetProgramPipelineInfoLog(int i);

    public static native void glGetProgramPipelineiv(int i, int j, IntBuffer intbuffer);

    public static native void glGetProgramPipelineiv(int i, int j, int ai[], int k);

    public static native int glGetProgramResourceIndex(int i, int j, String s);

    public static native int glGetProgramResourceLocation(int i, int j, String s);

    public static native String glGetProgramResourceName(int i, int j, int k);

    public static native void glGetProgramResourceiv(int i, int j, int k, int l, IntBuffer intbuffer, int i1, IntBuffer intbuffer1, IntBuffer intbuffer2);

    public static native void glGetProgramResourceiv(int i, int j, int k, int l, int ai[], int i1, int j1, int ai1[], 
            int k1, int ai2[], int l1);

    public static native void glGetTexLevelParameterfv(int i, int j, int k, FloatBuffer floatbuffer);

    public static native void glGetTexLevelParameterfv(int i, int j, int k, float af[], int l);

    public static native void glGetTexLevelParameteriv(int i, int j, int k, IntBuffer intbuffer);

    public static native void glGetTexLevelParameteriv(int i, int j, int k, int ai[], int l);
    ...
    public static native void glProgramUniform1f(int i, int j, float f);

    public static native void glProgramUniform1fv(int i, int j, int k, FloatBuffer floatbuffer);

    public static native void glProgramUniform1fv(int i, int j, int k, float af[], int l);

    public static native void glProgramUniform1i(int i, int j, int k);

    public static native void glProgramUniform1iv(int i, int j, int k, IntBuffer intbuffer);

    public static native void glProgramUniform1iv(int i, int j, int k, int ai[], int l);

    public static native void glProgramUniform1ui(int i, int j, int k);

    public static native void glProgramUniform1uiv(int i, int j, int k, IntBuffer intbuffer);

    public static native void glProgramUniform1uiv(int i, int j, int k, int ai[], int l);

    public static native void glProgramUniform2f(int i, int j, float f, float f1);

    public static native void glProgramUniform2fv(int i, int j, int k, FloatBuffer floatbuffer);

    public static native void glProgramUniform2fv(int i, int j, int k, float af[], int l);

    public static native void glProgramUniform2i(int i, int j, int k, int l);

    public static native void glProgramUniform2iv(int i, int j, int k, IntBuffer intbuffer);

    public static native void glProgramUniform2iv(int i, int j, int k, int ai[], int l);

    public static native void glProgramUniform2ui(int i, int j, int k, int l);

    public static native void glProgramUniform2uiv(int i, int j, int k, IntBuffer intbuffer);

    public static native void glProgramUniform2uiv(int i, int j, int k, int ai[], int l);

    public static native void glProgramUniform3f(int i, int j, float f, float f1, float f2);

    public static native void glProgramUniform3fv(int i, int j, int k, FloatBuffer floatbuffer);

    public static native void glProgramUniform3fv(int i, int j, int k, float af[], int l);

    public static native void glProgramUniform3i(int i, int j, int k, int l, int i1);

    public static native void glProgramUniform3iv(int i, int j, int k, IntBuffer intbuffer);

    public static native void glProgramUniform3iv(int i, int j, int k, int ai[], int l);

    public static native void glProgramUniform3ui(int i, int j, int k, int l, int i1);

    public static native void glProgramUniform3uiv(int i, int j, int k, IntBuffer intbuffer);

    public static native void glProgramUniform3uiv(int i, int j, int k, int ai[], int l);

    public static native void glProgramUniform4f(int i, int j, float f, float f1, float f2, float f3);

    public static native void glProgramUniform4fv(int i, int j, int k, FloatBuffer floatbuffer);

    public static native void glProgramUniform4fv(int i, int j, int k, float af[], int l);

    public static native void glProgramUniform4i(int i, int j, int k, int l, int i1, int j1);

    public static native void glProgramUniform4iv(int i, int j, int k, IntBuffer intbuffer);

    public static native void glProgramUniform4iv(int i, int j, int k, int ai[], int l);

    public static native void glProgramUniform4ui(int i, int j, int k, int l, int i1, int j1);

    public static native void glProgramUniform4uiv(int i, int j, int k, IntBuffer intbuffer);

    public static native void glProgramUniform4uiv(int i, int j, int k, int ai[], int l);

    public static native void glProgramUniformMatrix2fv(int i, int j, int k, boolean flag, FloatBuffer floatbuffer);

    public static native void glProgramUniformMatrix2fv(int i, int j, int k, boolean flag, float af[], int l);

    public static native void glProgramUniformMatrix2x3fv(int i, int j, int k, boolean flag, FloatBuffer floatbuffer);

    public static native void glProgramUniformMatrix2x3fv(int i, int j, int k, boolean flag, float af[], int l);

    public static native void glProgramUniformMatrix2x4fv(int i, int j, int k, boolean flag, FloatBuffer floatbuffer);

    public static native void glProgramUniformMatrix2x4fv(int i, int j, int k, boolean flag, float af[], int l);

    public static native void glProgramUniformMatrix3fv(int i, int j, int k, boolean flag, FloatBuffer floatbuffer);

    public static native void glProgramUniformMatrix3fv(int i, int j, int k, boolean flag, float af[], int l);

    public static native void glProgramUniformMatrix3x2fv(int i, int j, int k, boolean flag, FloatBuffer floatbuffer);

    public static native void glProgramUniformMatrix3x2fv(int i, int j, int k, boolean flag, float af[], int l);

    public static native void glProgramUniformMatrix3x4fv(int i, int j, int k, boolean flag, FloatBuffer floatbuffer);

    public static native void glProgramUniformMatrix3x4fv(int i, int j, int k, boolean flag, float af[], int l);

    public static native void glProgramUniformMatrix4fv(int i, int j, int k, boolean flag, FloatBuffer floatbuffer);

    public static native void glProgramUniformMatrix4fv(int i, int j, int k, boolean flag, float af[], int l);

    public static native void glProgramUniformMatrix4x2fv(int i, int j, int k, boolean flag, FloatBuffer floatbuffer);

    public static native void glProgramUniformMatrix4x2fv(int i, int j, int k, boolean flag, float af[], int l);

    public static native void glProgramUniformMatrix4x3fv(int i, int j, int k, boolean flag, FloatBuffer floatbuffer);

    public static native void glProgramUniformMatrix4x3fv(int i, int j, int k, boolean flag, float af[], int l);

    public static native void glSampleMaski(int i, int j);

    public static native void glTexStorage2DMultisample(int i, int j, int k, int l, int i1, boolean flag);

    public static native void glUseProgramStages(int i, int j, int k);

    public static native void glValidateProgramPipeline(int i);

    public static native void glVertexAttribBinding(int i, int j);

    public static native void glVertexAttribFormat(int i, int j, int k, boolean flag, int l);

    public static native void glVertexAttribIFormat(int i, int j, int k, int l);

    public static native void glVertexBindingDivisor(int i, int j);
