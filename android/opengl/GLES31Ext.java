...
public class GLES31Ext
{
    ...
    public static native void glBlendEquationSeparateiEXT(int i, int j, int k);

    public static native void glBlendEquationiEXT(int i, int j);

    public static native void glBlendFuncSeparateiEXT(int i, int j, int k, int l, int i1);

    public static native void glBlendFunciEXT(int i, int j, int k);

    public static native void glColorMaskiEXT(int i, boolean flag, boolean flag1, boolean flag2, boolean flag3);

    public static native void glCopyImageSubDataEXT(int i, int j, int k, int l, int i1, int j1, int k1, int l1, 
    ...
    public static native void glDebugMessageControlKHR(int i, int j, int k, int l, IntBuffer intbuffer, boolean flag);

    public static native void glDebugMessageControlKHR(int i, int j, int k, int l, int ai[], int i1, boolean flag);

    public static native void glDebugMessageInsertKHR(int i, int j, int k, int l, String s);

    public static native void glDisableiEXT(int i, int j);

    public static native void glEnableiEXT(int i, int j);

    public static native void glFramebufferTextureEXT(int i, int j, int k, int l);

    public static native DebugProcKHR glGetDebugMessageCallbackKHR();

    public static native int glGetDebugMessageLogKHR(int i, int j, int ai[], int k, int ai1[], int l, int ai2[], int i1, 
            int ai3[], int j1, int ai4[], int k1, byte abyte0[], int l1);

    public static native int glGetDebugMessageLogKHR(int i, IntBuffer intbuffer, IntBuffer intbuffer1, IntBuffer intbuffer2, IntBuffer intbuffer3, IntBuffer intbuffer4, ByteBuffer bytebuffer);

    public static native String[] glGetDebugMessageLogKHR(int i, IntBuffer intbuffer, IntBuffer intbuffer1, IntBuffer intbuffer2, IntBuffer intbuffer3);

    public static native String[] glGetDebugMessageLogKHR(int i, int ai[], int j, int ai1[], int k, int ai2[], int l, int ai3[], 
            int i1);

    public static native String glGetObjectLabelKHR(int i, int j);

    public static native String glGetObjectPtrLabelKHR(long l);

    public static native void glGetSamplerParameterIivEXT(int i, int j, IntBuffer intbuffer);

    public static native void glGetSamplerParameterIivEXT(int i, int j, int ai[], int k);

    public static native void glGetSamplerParameterIuivEXT(int i, int j, IntBuffer intbuffer);

    public static native void glGetSamplerParameterIuivEXT(int i, int j, int ai[], int k);

    public static native void glGetTexParameterIivEXT(int i, int j, IntBuffer intbuffer);

    public static native void glGetTexParameterIivEXT(int i, int j, int ai[], int k);

    public static native void glGetTexParameterIuivEXT(int i, int j, IntBuffer intbuffer);

    public static native void glGetTexParameterIuivEXT(int i, int j, int ai[], int k);

    public static native boolean glIsEnablediEXT(int i, int j);

    public static native void glMinSampleShadingOES(float f);

    public static native void glObjectLabelKHR(int i, int j, int k, String s);

    public static native void glObjectPtrLabelKHR(long l, String s);

    public static native void glPatchParameteriEXT(int i, int j);

    public static native void glPopDebugGroupKHR();

    public static native void glPrimitiveBoundingBoxEXT(float f, float f1, float f2, float f3, float f4, float f5, float f6, float f7);

    public static native void glPushDebugGroupKHR(int i, int j, int k, String s);

    public static native void glSamplerParameterIivEXT(int i, int j, IntBuffer intbuffer);

    public static native void glSamplerParameterIivEXT(int i, int j, int ai[], int k);

    public static native void glSamplerParameterIuivEXT(int i, int j, IntBuffer intbuffer);

    public static native void glSamplerParameterIuivEXT(int i, int j, int ai[], int k);

    public static native void glTexBufferEXT(int i, int j, int k);

    public static native void glTexBufferRangeEXT(int i, int j, int k, int l, int i1);

    public static native void glTexParameterIivEXT(int i, int j, IntBuffer intbuffer);

    public static native void glTexParameterIivEXT(int i, int j, int ai[], int k);

    public static native void glTexParameterIuivEXT(int i, int j, IntBuffer intbuffer);

    public static native void glTexParameterIuivEXT(int i, int j, int ai[], int k);

    public static native void glTexStorage3DMultisampleOES(int i, int j, int k, int l, int i1, int j1, boolean flag);
