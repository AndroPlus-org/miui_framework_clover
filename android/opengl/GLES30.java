...
public class GLES30 extends GLES20
{
    ...
    public static native void glBeginQuery(int i, int j);

    public static native void glBeginTransformFeedback(int i);

    public static native void glBindBufferBase(int i, int j, int k);

    public static native void glBindBufferRange(int i, int j, int k, int l, int i1);

    public static native void glBindSampler(int i, int j);

    public static native void glBindTransformFeedback(int i, int j);

    public static native void glBindVertexArray(int i);

    public static native void glBlitFramebuffer(int i, int j, int k, int l, int i1, int j1, int k1, int l1, 
            int i2, int j2);

    public static native void glClearBufferfi(int i, int j, float f, int k);

    public static native void glClearBufferfv(int i, int j, FloatBuffer floatbuffer);

    public static native void glClearBufferfv(int i, int j, float af[], int k);

    public static native void glClearBufferiv(int i, int j, IntBuffer intbuffer);

    public static native void glClearBufferiv(int i, int j, int ai[], int k);

    public static native void glClearBufferuiv(int i, int j, IntBuffer intbuffer);

    public static native void glClearBufferuiv(int i, int j, int ai[], int k);

    public static native int glClientWaitSync(long l, int i, long l1);

    public static native void glCompressedTexImage3D(int i, int j, int k, int l, int i1, int j1, int k1, int l1, 
            int i2);

    public static native void glCompressedTexImage3D(int i, int j, int k, int l, int i1, int j1, int k1, int l1, 
            Buffer buffer);

    public static native void glCompressedTexSubImage3D(int i, int j, int k, int l, int i1, int j1, int k1, int l1, 
            int i2, int j2, int k2);

    public static native void glCompressedTexSubImage3D(int i, int j, int k, int l, int i1, int j1, int k1, int l1, 
            int i2, int j2, Buffer buffer);

    public static native void glCopyBufferSubData(int i, int j, int k, int l, int i1);

    public static native void glCopyTexSubImage3D(int i, int j, int k, int l, int i1, int j1, int k1, int l1, 
            int i2);

    public static native void glDeleteQueries(int i, IntBuffer intbuffer);

    public static native void glDeleteQueries(int i, int ai[], int j);

    public static native void glDeleteSamplers(int i, IntBuffer intbuffer);

    public static native void glDeleteSamplers(int i, int ai[], int j);
    ...
    public static native void glDeleteTransformFeedbacks(int i, int ai[], int j);

    public static native void glDeleteVertexArrays(int i, IntBuffer intbuffer);

    public static native void glDeleteVertexArrays(int i, int ai[], int j);

    public static native void glDrawArraysInstanced(int i, int j, int k, int l);

    public static native void glDrawBuffers(int i, IntBuffer intbuffer);

    public static native void glDrawBuffers(int i, int ai[], int j);

    public static native void glDrawElementsInstanced(int i, int j, int k, int l, int i1);

    public static native void glDrawElementsInstanced(int i, int j, int k, Buffer buffer, int l);

    public static native void glDrawRangeElements(int i, int j, int k, int l, int i1, int j1);

    public static native void glDrawRangeElements(int i, int j, int k, int l, int i1, Buffer buffer);

    public static native void glEndQuery(int i);

    public static native void glEndTransformFeedback();

    public static native long glFenceSync(int i, int j);

    public static native void glFlushMappedBufferRange(int i, int j, int k);

    public static native void glFramebufferTextureLayer(int i, int j, int k, int l, int i1);

    public static native void glGenQueries(int i, IntBuffer intbuffer);

    public static native void glGenQueries(int i, int ai[], int j);

    public static native void glGenSamplers(int i, IntBuffer intbuffer);

    public static native void glGenSamplers(int i, int ai[], int j);

    public static native void glGenTransformFeedbacks(int i, IntBuffer intbuffer);

    public static native void glGenTransformFeedbacks(int i, int ai[], int j);

    public static native void glGenVertexArrays(int i, IntBuffer intbuffer);

    public static native void glGenVertexArrays(int i, int ai[], int j);

    public static native String glGetActiveUniformBlockName(int i, int j);

    public static native void glGetActiveUniformBlockName(int i, int j, int k, int ai[], int l, byte abyte0[], int i1);

    public static native void glGetActiveUniformBlockName(int i, int j, Buffer buffer, Buffer buffer1);

    public static native void glGetActiveUniformBlockiv(int i, int j, int k, IntBuffer intbuffer);

    public static native void glGetActiveUniformBlockiv(int i, int j, int k, int ai[], int l);

    public static native void glGetActiveUniformsiv(int i, int j, IntBuffer intbuffer, int k, IntBuffer intbuffer1);

    public static native void glGetActiveUniformsiv(int i, int j, int ai[], int k, int l, int ai1[], int i1);

    public static native void glGetBufferParameteri64v(int i, int j, LongBuffer longbuffer);

    public static native void glGetBufferParameteri64v(int i, int j, long al[], int k);

    public static native Buffer glGetBufferPointerv(int i, int j);

    public static native int glGetFragDataLocation(int i, String s);

    public static native void glGetInteger64i_v(int i, int j, LongBuffer longbuffer);

    public static native void glGetInteger64i_v(int i, int j, long al[], int k);

    public static native void glGetInteger64v(int i, LongBuffer longbuffer);

    public static native void glGetInteger64v(int i, long al[], int j);

    public static native void glGetIntegeri_v(int i, int j, IntBuffer intbuffer);

    public static native void glGetIntegeri_v(int i, int j, int ai[], int k);

    public static native void glGetInternalformativ(int i, int j, int k, int l, IntBuffer intbuffer);

    public static native void glGetInternalformativ(int i, int j, int k, int l, int ai[], int i1);

    public static native void glGetProgramBinary(int i, int j, IntBuffer intbuffer, IntBuffer intbuffer1, Buffer buffer);

    public static native void glGetProgramBinary(int i, int j, int ai[], int k, int ai1[], int l, Buffer buffer);

    public static native void glGetQueryObjectuiv(int i, int j, IntBuffer intbuffer);

    public static native void glGetQueryObjectuiv(int i, int j, int ai[], int k);

    public static native void glGetQueryiv(int i, int j, IntBuffer intbuffer);

    public static native void glGetQueryiv(int i, int j, int ai[], int k);

    public static native void glGetSamplerParameterfv(int i, int j, FloatBuffer floatbuffer);

    public static native void glGetSamplerParameterfv(int i, int j, float af[], int k);

    public static native void glGetSamplerParameteriv(int i, int j, IntBuffer intbuffer);

    public static native void glGetSamplerParameteriv(int i, int j, int ai[], int k);

    public static native String glGetStringi(int i, int j);

    public static native void glGetSynciv(long l, int i, int j, IntBuffer intbuffer, IntBuffer intbuffer1);

    public static native void glGetSynciv(long l, int i, int j, int ai[], int k, int ai1[], int i1);

    public static native String glGetTransformFeedbackVarying(int i, int j, IntBuffer intbuffer, IntBuffer intbuffer1);

    public static native String glGetTransformFeedbackVarying(int i, int j, int ai[], int k, int ai1[], int l);

    public static native void glGetTransformFeedbackVarying(int i, int j, int k, IntBuffer intbuffer, IntBuffer intbuffer1, IntBuffer intbuffer2, byte byte0);

    public static native void glGetTransformFeedbackVarying(int i, int j, int k, IntBuffer intbuffer, IntBuffer intbuffer1, IntBuffer intbuffer2, ByteBuffer bytebuffer);

    public static native void glGetTransformFeedbackVarying(int i, int j, int k, int ai[], int l, int ai1[], int i1, int ai2[], 
            int j1, byte abyte0[], int k1);

    public static native int glGetUniformBlockIndex(int i, String s);

    public static native void glGetUniformIndices(int i, String as[], IntBuffer intbuffer);

    public static native void glGetUniformIndices(int i, String as[], int ai[], int j);

    public static native void glGetUniformuiv(int i, int j, IntBuffer intbuffer);

    public static native void glGetUniformuiv(int i, int j, int ai[], int k);

    public static native void glGetVertexAttribIiv(int i, int j, IntBuffer intbuffer);

    public static native void glGetVertexAttribIiv(int i, int j, int ai[], int k);

    public static native void glGetVertexAttribIuiv(int i, int j, IntBuffer intbuffer);

    public static native void glGetVertexAttribIuiv(int i, int j, int ai[], int k);

    public static native void glInvalidateFramebuffer(int i, int j, IntBuffer intbuffer);

    public static native void glInvalidateFramebuffer(int i, int j, int ai[], int k);

    public static native void glInvalidateSubFramebuffer(int i, int j, IntBuffer intbuffer, int k, int l, int i1, int j1);

    public static native void glInvalidateSubFramebuffer(int i, int j, int ai[], int k, int l, int i1, int j1, int k1);
    ...
    public static native Buffer glMapBufferRange(int i, int j, int k, int l);

    public static native void glPauseTransformFeedback();

    public static native void glProgramBinary(int i, int j, Buffer buffer, int k);

    public static native void glProgramParameteri(int i, int j, int k);

    public static native void glReadBuffer(int i);

    public static native void glReadPixels(int i, int j, int k, int l, int i1, int j1, int k1);

    public static native void glRenderbufferStorageMultisample(int i, int j, int k, int l, int i1);

    public static native void glResumeTransformFeedback();

    public static native void glSamplerParameterf(int i, int j, float f);

    public static native void glSamplerParameterfv(int i, int j, FloatBuffer floatbuffer);

    public static native void glSamplerParameterfv(int i, int j, float af[], int k);

    public static native void glSamplerParameteri(int i, int j, int k);

    public static native void glSamplerParameteriv(int i, int j, IntBuffer intbuffer);

    public static native void glSamplerParameteriv(int i, int j, int ai[], int k);

    public static native void glTexImage3D(int i, int j, int k, int l, int i1, int j1, int k1, int l1, 
            int i2, int j2);

    public static native void glTexImage3D(int i, int j, int k, int l, int i1, int j1, int k1, int l1, 
            int i2, Buffer buffer);

    public static native void glTexStorage2D(int i, int j, int k, int l, int i1);

    public static native void glTexStorage3D(int i, int j, int k, int l, int i1, int j1);

    public static native void glTexSubImage3D(int i, int j, int k, int l, int i1, int j1, int k1, int l1, 
            int i2, int j2, int k2);

    public static native void glTexSubImage3D(int i, int j, int k, int l, int i1, int j1, int k1, int l1, 
            int i2, int j2, Buffer buffer);

    public static native void glTransformFeedbackVaryings(int i, String as[], int j);

    public static native void glUniform1ui(int i, int j);

    public static native void glUniform1uiv(int i, int j, IntBuffer intbuffer);

    public static native void glUniform1uiv(int i, int j, int ai[], int k);

    public static native void glUniform2ui(int i, int j, int k);

    public static native void glUniform2uiv(int i, int j, IntBuffer intbuffer);

    public static native void glUniform2uiv(int i, int j, int ai[], int k);

    public static native void glUniform3ui(int i, int j, int k, int l);

    public static native void glUniform3uiv(int i, int j, IntBuffer intbuffer);

    public static native void glUniform3uiv(int i, int j, int ai[], int k);

    public static native void glUniform4ui(int i, int j, int k, int l, int i1);

    public static native void glUniform4uiv(int i, int j, IntBuffer intbuffer);

    public static native void glUniform4uiv(int i, int j, int ai[], int k);

    public static native void glUniformBlockBinding(int i, int j, int k);

    public static native void glUniformMatrix2x3fv(int i, int j, boolean flag, FloatBuffer floatbuffer);

    public static native void glUniformMatrix2x3fv(int i, int j, boolean flag, float af[], int k);

    public static native void glUniformMatrix2x4fv(int i, int j, boolean flag, FloatBuffer floatbuffer);

    public static native void glUniformMatrix2x4fv(int i, int j, boolean flag, float af[], int k);

    public static native void glUniformMatrix3x2fv(int i, int j, boolean flag, FloatBuffer floatbuffer);

    public static native void glUniformMatrix3x2fv(int i, int j, boolean flag, float af[], int k);

    public static native void glUniformMatrix3x4fv(int i, int j, boolean flag, FloatBuffer floatbuffer);

    public static native void glUniformMatrix3x4fv(int i, int j, boolean flag, float af[], int k);

    public static native void glUniformMatrix4x2fv(int i, int j, boolean flag, FloatBuffer floatbuffer);

    public static native void glUniformMatrix4x2fv(int i, int j, boolean flag, float af[], int k);

    public static native void glUniformMatrix4x3fv(int i, int j, boolean flag, FloatBuffer floatbuffer);

    public static native void glUniformMatrix4x3fv(int i, int j, boolean flag, float af[], int k);

    public static native boolean glUnmapBuffer(int i);

    public static native void glVertexAttribDivisor(int i, int j);

    public static native void glVertexAttribI4i(int i, int j, int k, int l, int i1);

    public static native void glVertexAttribI4iv(int i, IntBuffer intbuffer);

    public static native void glVertexAttribI4iv(int i, int ai[], int j);

    public static native void glVertexAttribI4ui(int i, int j, int k, int l, int i1);

    public static native void glVertexAttribI4uiv(int i, IntBuffer intbuffer);

    public static native void glVertexAttribI4uiv(int i, int ai[], int j);

    public static native void glVertexAttribIPointer(int i, int j, int k, int l, int i1);

    public static void glVertexAttribIPointer(int i, int j, int k, int l, Buffer buffer)
    {
        glVertexAttribIPointerBounds(i, j, k, l, buffer, buffer.remaining());
    }

    private static native void glVertexAttribIPointerBounds(int i, int j, int k, int l, Buffer buffer, int i1);

    public static native void glWaitSync(long l, int i, long l1);
