...
public class GLES32 extends GLES31
{
    public static interface DebugProc
    {
        ...
        public abstract void onMessage(int i, int j, int k, int l, String s);
    }
    ...
    public static native void glBlendEquationSeparatei(int i, int j, int k);

    public static native void glBlendEquationi(int i, int j);

    public static native void glBlendFuncSeparatei(int i, int j, int k, int l, int i1);

    public static native void glBlendFunci(int i, int j, int k);

    public static native void glColorMaski(int i, boolean flag, boolean flag1, boolean flag2, boolean flag3);

    public static native void glCopyImageSubData(int i, int j, int k, int l, int i1, int j1, int k1, int l1, 
            int i2, int j2, int k2, int l2, int i3, int j3, int k3);

    public static native void glDebugMessageCallback(DebugProc debugproc);

    public static native void glDebugMessageControl(int i, int j, int k, int l, IntBuffer intbuffer, boolean flag);

    public static native void glDebugMessageControl(int i, int j, int k, int l, int ai[], int i1, boolean flag);

    public static native void glDebugMessageInsert(int i, int j, int k, int l, int i1, String s);

    public static native void glDisablei(int i, int j);

    public static native void glDrawElementsBaseVertex(int i, int j, int k, Buffer buffer, int l);

    public static native void glDrawElementsInstancedBaseVertex(int i, int j, int k, int l, int i1, int j1);

    public static native void glDrawElementsInstancedBaseVertex(int i, int j, int k, Buffer buffer, int l, int i1);

    public static native void glDrawRangeElementsBaseVertex(int i, int j, int k, int l, int i1, Buffer buffer, int j1);

    public static native void glEnablei(int i, int j);

    public static native void glFramebufferTexture(int i, int j, int k, int l);

    public static native int glGetDebugMessageLog(int i, int j, int ai[], int k, int ai1[], int l, int ai2[], int i1, 
            int ai3[], int j1, int ai4[], int k1, byte abyte0[], int l1);

    public static native int glGetDebugMessageLog(int i, IntBuffer intbuffer, IntBuffer intbuffer1, IntBuffer intbuffer2, IntBuffer intbuffer3, IntBuffer intbuffer4, ByteBuffer bytebuffer);

    public static native String[] glGetDebugMessageLog(int i, IntBuffer intbuffer, IntBuffer intbuffer1, IntBuffer intbuffer2, IntBuffer intbuffer3);

    public static native String[] glGetDebugMessageLog(int i, int ai[], int j, int ai1[], int k, int ai2[], int l, int ai3[], 
            int i1);

    public static native int glGetGraphicsResetStatus();

    public static native String glGetObjectLabel(int i, int j);

    public static native String glGetObjectPtrLabel(long l);

    public static native long glGetPointerv(int i);

    public static native void glGetSamplerParameterIiv(int i, int j, IntBuffer intbuffer);

    public static native void glGetSamplerParameterIiv(int i, int j, int ai[], int k);

    public static native void glGetSamplerParameterIuiv(int i, int j, IntBuffer intbuffer);

    public static native void glGetSamplerParameterIuiv(int i, int j, int ai[], int k);

    public static native void glGetTexParameterIiv(int i, int j, IntBuffer intbuffer);

    public static native void glGetTexParameterIiv(int i, int j, int ai[], int k);

    public static native void glGetTexParameterIuiv(int i, int j, IntBuffer intbuffer);

    public static native void glGetTexParameterIuiv(int i, int j, int ai[], int k);

    public static native void glGetnUniformfv(int i, int j, int k, FloatBuffer floatbuffer);

    public static native void glGetnUniformfv(int i, int j, int k, float af[], int l);

    public static native void glGetnUniformiv(int i, int j, int k, IntBuffer intbuffer);

    public static native void glGetnUniformiv(int i, int j, int k, int ai[], int l);

    public static native void glGetnUniformuiv(int i, int j, int k, IntBuffer intbuffer);

    public static native void glGetnUniformuiv(int i, int j, int k, int ai[], int l);

    public static native boolean glIsEnabledi(int i, int j);

    public static native void glMinSampleShading(float f);

    public static native void glObjectLabel(int i, int j, int k, String s);

    public static native void glObjectPtrLabel(long l, String s);

    public static native void glPatchParameteri(int i, int j);

    public static native void glPopDebugGroup();

    public static native void glPrimitiveBoundingBox(float f, float f1, float f2, float f3, float f4, float f5, float f6, float f7);

    public static native void glPushDebugGroup(int i, int j, int k, String s);

    public static native void glReadnPixels(int i, int j, int k, int l, int i1, int j1, int k1, Buffer buffer);

    public static native void glSamplerParameterIiv(int i, int j, IntBuffer intbuffer);

    public static native void glSamplerParameterIiv(int i, int j, int ai[], int k);

    public static native void glSamplerParameterIuiv(int i, int j, IntBuffer intbuffer);

    public static native void glSamplerParameterIuiv(int i, int j, int ai[], int k);

    public static native void glTexBuffer(int i, int j, int k);

    public static native void glTexBufferRange(int i, int j, int k, int l, int i1);

    public static native void glTexParameterIiv(int i, int j, IntBuffer intbuffer);

    public static native void glTexParameterIiv(int i, int j, int ai[], int k);

    public static native void glTexParameterIuiv(int i, int j, IntBuffer intbuffer);

    public static native void glTexParameterIuiv(int i, int j, int ai[], int k);

    public static native void glTexStorage3DMultisample(int i, int j, int k, int l, int i1, int j1, boolean flag);
