...
public class VoicemailContract
{
        ...
        implements BaseColumns, OpenableColumns
    {
        ...
        private static ContentValues getContentValues(Voicemail voicemail)
        {
            ...
            phoneaccounthandle = voicemail.getPhoneAccount();
        ...
        public static int insert(Context context, List list)
        {
            ContentResolver contentresolver = context.getContentResolver();
            int i = list.size();
            for(int j = 0; j < i; j++)
            {
                ContentValues contentvalues = getContentValues((Voicemail)list.get(j));
        ...
        {
            ContentResolver contentresolver = context.getContentResolver();
            voicemail = getContentValues(voicemail);
            return contentresolver.insert(buildSourceUri(context.getPackageName()), voicemail);
        }
