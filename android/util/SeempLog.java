...
public final class SeempLog
{
    ...
    public static int getSeempGetApiIdFromValue(String s)
    {
        Integer integer = (Integer)value_to_get_map.get(s);
        s = integer;
        if(integer == null)
            s = Integer.valueOf(-1);
        return s.intValue();
    ...
    public static int getSeempPutApiIdFromValue(String s)
    {
        Integer integer = (Integer)value_to_put_map.get(s);
        s = integer;
        if(integer == null)
            s = Integer.valueOf(-1);
        return s.intValue();
    ...
    {
        return seemp_println_native(i, "");
    }

    public static int record_sensor(int i, Sensor sensor)
    {
        if(sensor != null)
            return seemp_println_native(i, (new StringBuilder()).append("sensor=").append(sensor.getType()).toString());
        else
            return seemp_println_native(i, "sensor=-1");
    }

    public static int record_sensor_rate(int i, Sensor sensor, int j)
    {
        if(sensor != null)
            return seemp_println_native(i, (new StringBuilder()).append("sensor=").append(sensor.getType()).append(",rate=").append(j).toString());
        else
            return seemp_println_native(i, (new StringBuilder()).append("sensor=-1,rate=").append(j).toString());
    }

    public static int record_str(int i, String s)
    {
        if(s != null)
            return seemp_println_native(i, s);
        else
            return seemp_println_native(i, "");
    }

    public static int record_uri(int i, Uri uri)
    {
        if(uri != null)
            return seemp_println_native(i, (new StringBuilder()).append("uri, ").append(uri.toString()).toString());
        else
            return seemp_println_native(i, "uri, null");
    }

    public static int record_vg_layout(int i, android.view.ViewGroup.LayoutParams layoutparams)
    {
        android.view.WindowManager.LayoutParams layoutparams1;
        int j;
        try
        {
            layoutparams1 = (android.view.WindowManager.LayoutParams)layoutparams;
        }
        ...
        layoutparams = JVM INSTR new #671 <Class StringBuilder>;
        layoutparams.StringBuilder();
        return seemp_println_native(i, layoutparams.append("window_type=").append(layoutparams1.type).append(",window_flag=").append(layoutparams1.flags).toString());
        j = seemp_println_native(i, "");
        return j;
    }

    public static native int seemp_println_native(int i, String s);
    ...
    private static final Map value_to_get_map;
    private static final Map value_to_put_map;

    static 
    {
        value_to_get_map = new HashMap(198);
