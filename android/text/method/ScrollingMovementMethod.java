    ...
    implements MovementMethod
{
    ...
    public void onTakeFocus(TextView textview, Spannable spannable, int i)
    {
        ...
        if(spannable != null && (i & 2) != 0)
            textview.scrollTo(textview.getScrollX(), spannable.getLineTop(0));
        if(spannable != null && (i & 1) != 0)
        {
            i = textview.getTotalPaddingTop();
            int j = textview.getTotalPaddingBottom();
            int k = spannable.getLineCount();
            textview.scrollTo(textview.getScrollX(), spannable.getLineTop((k - 1) + 1) - (textview.getHeight() - (i + j)));
        }
    }
