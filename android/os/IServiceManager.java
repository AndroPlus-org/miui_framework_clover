    ...
    extends IInterface
{
    ...
    public abstract void addService(String s, IBinder ibinder, boolean flag)
    ...
    public abstract void setPermissionController(IPermissionController ipermissioncontroller)
        throws RemoteException;
