...
public class SerialPort
{
    ...
    private native void native_open(FileDescriptor filedescriptor, int i)
        throws IOException;

    private native int native_read_array(byte abyte0[], int i)
        throws IOException;
    ...
    private native void native_write_array(byte abyte0[], int i)
        throws IOException;
    ...
    public void open(ParcelFileDescriptor parcelfiledescriptor, int i)
        throws IOException
    {
