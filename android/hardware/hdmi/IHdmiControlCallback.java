...
public interface IHdmiControlCallback
    extends IInterface
{
        ...
        implements IHdmiControlCallback
    {
        ...
        public static IHdmiControlCallback asInterface(IBinder ibinder)
        {
            if(ibinder == null)
                return null;
            IInterface iinterface = ibinder.queryLocalInterface("android.hardware.hdmi.IHdmiControlCallback");
            if(iinterface != null && (iinterface instanceof IHdmiControlCallback))
                return (IHdmiControlCallback)iinterface;
            else
            ...
            throws RemoteException
        {
            ...
            case 1598968902: 
                parcel1.writeString("android.hardware.hdmi.IHdmiControlCallback");
                return true;

            case 1: // '\001'
                parcel.enforceInterface("android.hardware.hdmi.IHdmiControlCallback");
