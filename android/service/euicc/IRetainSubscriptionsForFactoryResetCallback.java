    ...
    extends IInterface
{
        ...
        implements IRetainSubscriptionsForFactoryResetCallback
    {
        ...
        public static IRetainSubscriptionsForFactoryResetCallback asInterface(IBinder ibinder)
        {
            if(ibinder == null)
                return null;
            IInterface iinterface = ibinder.queryLocalInterface("android.service.euicc.IRetainSubscriptionsForFactoryResetCallback");
            ...
            throws RemoteException
        {
            ...
            case 1598968902: 
                parcel1.writeString("android.service.euicc.IRetainSubscriptionsForFactoryResetCallback");
                return true;

            case 1: // '\001'
                parcel.enforceInterface("android.service.euicc.IRetainSubscriptionsForFactoryResetCallback");
