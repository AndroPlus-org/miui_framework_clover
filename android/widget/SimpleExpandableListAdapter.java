...
public class SimpleExpandableListAdapter extends BaseExpandableListAdapter
{
    ...
    {
        if(view == null)
            view = newChildView(flag, viewgroup);
        bindView(view, (Map)((List)mChildData.get(i)).get(j), mChildFrom, mChildTo);
        return view;
    }
    ...
    {
        if(view == null)
            view = newGroupView(flag, viewgroup);
        bindView(view, (Map)mGroupData.get(i), mGroupFrom, mGroupTo);
        return view;
    }
