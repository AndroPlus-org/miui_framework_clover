...
{
    public static final class CardUnavailableReason extends Enum
    {

        public static CardUnavailableReason valueOf(String s)
        {
            return (CardUnavailableReason)Enum.valueOf(com/android/internal/telephony/PhoneConstants$CardUnavailableReason, s);
        }
        ...
        private static final CardUnavailableReason $VALUES[];
        public static final CardUnavailableReason REASON_CARD_REMOVED;
        public static final CardUnavailableReason REASON_RADIO_UNAVAILABLE;
        public static final CardUnavailableReason REASON_SIM_REFRESH_RESET;
        ...
        static 
        {
            ...
            $VALUES = (new CardUnavailableReason[] {
                REASON_CARD_REMOVED, REASON_RADIO_UNAVAILABLE, REASON_SIM_REFRESH_RESET
            });
        }

        private CardUnavailableReason(String s, int i)
        {
            super(s, i);
        }
    }
    ...
    public static final class DataState extends Enum
    {
        ...
        {
            return (DataState)Enum.valueOf(com/android/internal/telephony/PhoneConstants$DataState, s);
        }
    ...
    public static final class State extends Enum
    {
        ...
        {
            return (State)Enum.valueOf(com/android/internal/telephony/PhoneConstants$State, s);
        }
